...
public class ProjectUpdatesActivity2 extends AppCompatActivity{
...
//                        String responseUpdate = object.getString("response") ;
                        ...
                        Toast.makeText(ProjectUpdatesActivity2.this, " " + responseUpdate, Toast.LENGTH_SHORT).show();
...
//        DialogImageProjectListAdapter productAdapter = new DialogImageProjectListAdapter(getApplicationContext(), selectImages);
//        mImgTextRecycler.setAdapter(productAdapter);
        ...
        mCountImgText.setText((1)+"/"+selectImages.size());
...
//                    Toast.makeText(ProjectUpdatesActivity.this, "newstate: "+ p1+""+p2+""+p3, Toast.LENGTH_SHORT).show();
                    mCountImgText.setText((p3+1)+"/"+selectImages.size());
    ...
    private void getImageUriResult(Uri imageuri) {
        ...
        try {
            bitmapSrc = MediaStore.Images.Media.getBitmap(ProjectUpdatesActivity2.this.getContentResolver(), imageuri);
        } catch (Exception e) {
            e.printStackTrace();
        }
